...
class PetugasController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboardpetugas', compact(
            ...
            'totalHewan', 'antrian', 'antrianSelesai'
        ));
    }

    public function daftarHewanBaru()
    {
        return view('petugas.daftar-hewan');
    }
    ...
    public function prosesAntrian($id)
    {
        try {
            ...
            return redirect()->back()->with('success', 'Hewan sedang diproses');
        } catch (\Exception $e) {
            DB::rollBack();
    ...
    public function selesaiAntrian($id)
    {
        try {
            ...
            return redirect()->back()->with('success', 'Hewan telah selesai dilayani dan riwayat kunjungan telah dicatat');
        } catch (\Exception $e) {
            DB::rollBack();

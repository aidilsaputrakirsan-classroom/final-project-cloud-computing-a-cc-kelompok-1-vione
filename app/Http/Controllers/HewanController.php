...
class HewanController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($dataHewan) {
            ...
            $dashboardData['totalKunjungan'] = Antrian::where('id_hewan', $dataHewan->id)
            ...
            $dashboardData['totalResep'] = Antrian::where('id_hewan', $dataHewan->id)
                ->where('status', 'dilayani')
                ->count();
                
            // Get next upcoming appointment
            $nextAppointment = Antrian::where('id_hewan', $dataHewan->id)
            ...
            $dashboardData['upcomingAppointments'] = Antrian::where('id_hewan', $dataHewan->id)
                ->whereIn('status', ['menunggu', 'diproses'])
                ->orderBy('tanggal_berobat', 'asc')
                ->get();
        }
        ...
        return view('dashboardhewan', compact('dataHewan', 'dashboardData'));
    }
    ...
    public function jadwalPeriksa()
    {
        ...
        return view('hewan.jadwal-periksa', compact('jadwalPoliklinik', 'dokters', 'polikliniks'));
    }
    ...
    public function riwayatPeriksa()
    {
        ...
        if (!$datahewan) {
            return redirect()->route('hewan.create')->with('error', 'Harap lengkapi data hewan terlebih dahulu');
        }
        
        // Get all completed appointments for this patient
        $riwayat = Antrian::where('id_hewan', $datahewan->id)
            ->where('status', 'dilayani')
        ...
        $riwayatKunjungan = RiwayatKunjungan::where('hewan_id', $datahewan->id)
            ->orderBy('tanggal_kunjungan', 'desc')
            ->get();
            
        return view('hewan.riwayat-periksa', compact('riwayat', 'riwayatKunjungan'));
    }
    ...
    public function profil()
    {
        ...
        return view('hewan.profil', compact('profil'));
    }
    ...
    public function riwayatAntrian()
    {
        ...
        return view('hewan.riwayat-antrian', compact('antrianAktif', 'riwayatAntrian'));
    }
}

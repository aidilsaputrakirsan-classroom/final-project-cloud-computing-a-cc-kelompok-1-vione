    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="heading-history">
          <h2>Sejarah Pawcare <span>Kami memulai di tahun 2025</span></h2>
        </div>
      </div>
      <div class="col-lg-6">
        <div class="heading-history">
            <p>PawCare didirikan pada tahun 2025 dengan satu tujuan sederhana: menghadirkan layanan perawatan hewan peliharaan yang aman, ramah, dan profesional. Berawal dari sebuah visi untuk menyatukan kecintaan terhadap hewan dengan standar pelayanan modern, PawCare muncul sebagai solusi bagi para pemilik hewan yang ingin memberikan perawatan terbaik bagi sahabat berbulu mereka.

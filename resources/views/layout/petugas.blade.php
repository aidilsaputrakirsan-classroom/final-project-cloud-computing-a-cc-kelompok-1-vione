...
<head>
    ...
    <title>@yield('title') - PawCare Staff Portal</title>
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('dashboard-petugas') }}">
            ...
            <div class="sidebar-brand-text mx-3">PawCare Staff</div>
        </a>
        ...
        <!-- Heading -->
        <div class="sidebar-heading">Pendaftaran Hewan</div>

        <!-- Register new pet -->
        <li class="nav-item {{ request()->routeIs('hewan.create') ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('hewan.create') }}">
                <i class="fas fa-fw fa-cat"></i>
                <span>Daftar Hewan Baru</span>
            </a>
        </li>
        ...
        <li class="nav-item {{ request()->routeIs('admin.registration') ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('admin.registration') }}">
                ...
                <span>Booking Jadwal Dokter Hewan</span>
            </a>
        </li>
        ...
        <!-- Layanan -->
        <div class="sidebar-heading">Layanan Klinik</div>
        ...
        {{-- FITUR REKAM MEDIS DINONAKTIFKAN --}}
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                    <div class="input-group">
                        <input type="text" class="form-control bg-light border-0 small" placeholder="Cari hewan..."
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow mx-1">
                        ...
                        <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            @if($waitingCount > 0)
                                <a class="dropdown-item d-flex align-items-center" href="{{ route('petugas.antrian') }}">
                                    ...
                                    <div>
                                        ...
                                        <span class="font-weight-bold">{{ $waitingCount }} hewan sedang menunggu</span>
                                    </div>
                                </a>
                            @else
                            ...
                            @endif
                            <a class="dropdown-item text-center small text-gray-500" href="{{ route('petugas.antrian') }}">Tampilkan Semua</a>
                        </div>
                    </li>
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; PawCare Veterinary Clinic {{ date('Y') }}</span>
                </div>
            </div>
        </footer>
    </div>
...
<script>
    ['logout-menu-item', 'logout-sidebar-item'].forEach(id => {
        ...
        if (el) {
            el.addEventListener('click', e => {
                ...
                Swal.fire({
                    ...
                    text: 'Pilih "Logout" jika kamu yakin ingin keluar dari portal staff.',
                    icon: 'warning',

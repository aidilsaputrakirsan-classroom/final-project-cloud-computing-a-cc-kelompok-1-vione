...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-success">Hewan Telah Dilayani Hari Ini</h6>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="antrianSelesaiTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                @empty
                                <tr>
                                    <td colspan="5" class="text-center">Belum ada hewan yang telah dilayani hari ini</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
        ...
        <div class="col-lg-4">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <a href="{{ route('hewan.create') }}" class="btn btn-success btn-icon-split btn-lg btn-block mb-3">
                        <span class="icon text-white-50">
                            <i class="fas fa-user-plus"></i>
                        </span>
                        <span class="text">Daftar Hewan Baru</span>
                    </a>
                    ...
                    <a href="{{ route('hewan.index') }}" class="btn btn-secondary btn-icon-split btn-lg btn-block">
                        <span class="icon text-white-50">
                            <i class="fas fa-users"></i>
                        </span>
                        <span class="text">Data Hewan</span>
                    </a>
                </div>
            </div>
        ...
        if ($('#antrianSelesaiTable tbody tr').length > 1 || 
           ($('#antrianSelesaiTable tbody tr').length == 1 && 
            ...
            $('#antrianSelesaiTable').DataTable({
                ...
                "responsive": true,
                "language": {
                    "emptyTable": "Belum ada hewan yang telah dilayani hari ini"
                }
            });
        }
    });

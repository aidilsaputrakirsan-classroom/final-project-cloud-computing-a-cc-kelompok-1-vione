...
@section('content')
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Data Hewan</h1>

<!-- Search Filter -->
<div class="card shadow mb-4">
    <div class="card-body">
        <form action="{{ route('hewan.index') }}" method="GET" class="row">
            ...
            <table class="table table-bordered" id="datatable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="d-flex">
                            <a href="{{ route('hewan.show', $item->id) }}" class="btn btn-info btn-sm mr-1"><i class="fas fa-eye"></i></a>
                            <a href="{{ route('hewan.edit', $item->id) }}" class="btn btn-warning btn-sm mr-1">Edit</a>
                            <form action="{{ route('hewan.destroy', $item->id) }}" method="POST" class="d-inline delete-form">
                                @csrf
                                @method('DELETE')
